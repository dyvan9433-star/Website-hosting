...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      g:"Verbal Identity & Messaging",h:"Packaging Design", i:"Trend", j:"Concept Testing", k:"Design Training", u:"Seyha",
    ...
    km: {
      ...
      z:"ហួត", eff:"ប្រសិទ្ធភាពនៃគេហទំព័រ",com:"ការទំនាក់ទំនងរហ័ស", enda:"គេហទំព័រ (Websites) ជួយសម្រួលដល់ការទំនាក់ទំនង និងអនុញ្ញាតឱ្យអ្នកប្រើប្រាស់អាចស្វែងរក ឬចូលទៅពិនិត្យព័ត៌មានបានយ៉ាងរហ័ស និងមានប្រសិទ្ធភាព។",
