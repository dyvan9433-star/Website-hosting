...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const translations = {
    en: {
      ...
      r:"Sen Makara", s:"Coding & Testing", t:"Role: Software Developer & QA Tester Education: Community Development Institute Experience: 3 Years in the Tech Industry (Software Development, Automation Testing, and Quality Assurance) Core Competencies 1. Creative Coding & Development Software Development: Capable of writing code, building new features, and troubleshooting technical system issues to effectively meet business requirements. Logic & Clean Code: Focused on writing well-structured, easy-to-understand, and clean code that ensures smooth maintenance and seamless scalability in the future.",
      plan:"Planning & Analysis",plan1:"Planning & Analysis", sek:"SEK SEYHA",
      x:"Role: Product Planning & Systems Analyst Education: Bachelor of Computer Science – Community Development Institute Experience: 3 Years in the Tech Industry (Project Management, Systems Analysis, and Quality Assurance) Core Competencies 1. Business & Systems Analysis Requirements Gathering: Researching and analyzing client needs and business goals, and translating them into detailed Functional Specifications for UX/UI design and development teams to execute. Feasibility Analysis: Evaluating system gaps, technical feasibility, and potential project risks prior to kickoff to minimize development delays and post-launch defects (bugs).",
      x1:"Role: Product Planning & Systems Analyst Education: Bachelor of Computer Science – Community Development Institute Experience: 3 Years in the Tech Industry (Project Management, Systems Analysis, and Quality Assurance) Core Competencies 1. Business & Systems Analysis Requirements Gathering: Researching and analyzing client needs and business goals, and translating them into detailed Functional Specifications for UX/UI design and development teams to execute. Feasibility Analysis: Evaluating system gaps, technical feasibility, and potential project risks prior to kickoff to minimize development delays and post-launch defects (bugs).",
    ...
    km: {
      ...
      z:"ឡុង សុខលាភ", eff:"ប្រសិទ្ធភាពនៃគេហទំព័រ",com:"ការទំនាក់ទំនងរហ័ស", enda:"គេហទំព័រ (Websites) ជួយសម្រួលដល់ការទំនាក់ទំនង និងអនុញ្ញាតឱ្យអ្នកប្រើប្រាស់អាចស្វែងរក ឬចូលទៅពិនិត្យព័ត៌មានបានយ៉ាងរហ័ស និងមានប្រសិទ្ធភាព។",
